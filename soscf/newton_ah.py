...
def _gen_rhf_response_scaled(mf, sf, mo_coeff=None, mo_occ=None,
        ...
        if singlet is None:  # Without specify singlet, general case
            def vind(dm1):
                ...
                if hybrid:
                    ...
                    v1 += mf.get_j(mol, dm1, hermi=hermi)*sf
                return v1
...
def _gen_uhf_response_scaled(mf, sf, mo_coeff=None, mo_occ=None,
